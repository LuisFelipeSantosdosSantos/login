...
<head>
  ...
  <title>Página de ciração de Nova Senha</title>
</head>
    ...
    <section class="row justify-content-center">
      <div class="col-lg-5 mt-5">
        ...
        <form action="" method="post">
          ...
          <div class="form-group">
            <label for="csenha">Confirmar a Senha</label>
            <input type="password" name="csenha" id="csenha" class="form-control" placeholder="Confirmar Nova Senha" required>
          </div>

          <div class="form-group">
            <input type="submit" value="Criar a nova senha" name="gerar" class="btn btn-block btn-info">
          </div>
        </form>
